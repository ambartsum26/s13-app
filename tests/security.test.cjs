...
assert.match(hardeningSource, /'SCRIPT', 'STYLE', 'TEMPLATE'/);
...
console.log('PASS: hardening components fail independently; script/CSS/template injection and unsafe links stay blocked.');
