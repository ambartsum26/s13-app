...
.app-logo {
    ...
    border-radius: 11px !important; background: var(--dz-green) !important; color: #fff !important; box-shadow: none !important;
}
...
.app-section-button {
    height:40px; min-height:40px; padding:0 13px !important; border-radius:10px !important;
    display:inline-flex; align-items:center; justify-content:center; gap:7px; font-size:10px; white-space:nowrap;
}

button:not([data-language-toggle]), a#map-link, a.mini-btn, .copy-map-btn {
    background:var(--dz-control) !important; color:#fff !important; border:none !important; outline:none !important;
...
button:not([data-language-toggle]):not(:disabled):hover, a#map-link:hover, a.mini-btn:hover, .copy-map-btn:hover {
    background:var(--dz-green-bright) !important; color:#11141a !important; transform:translateY(-1px) !important;
}
button:not([data-language-toggle]):focus-visible, a#map-link:focus-visible, a.mini-btn:focus-visible, input:focus-visible {
    outline:none !important; box-shadow:0 0 0 3px rgba(49,209,127,.14) !important;
}
button:disabled { opacity:.42 !important; cursor:not-allowed !important; transform:none !important; }

[data-language-toggle] {
    width:90px !important; height:40px !important; padding:4px !important; border:none !important; outline:none !important;
    border-radius:10px !important; background:#17171f !important; box-shadow:none !important;
}
...
#city-switcher-panel {
    padding:8px !important; border-radius:15px !important; overflow:hidden;
    background:var(--dz-panel) !important; box-shadow:0 10px 30px rgba(0,0,0,.18) !important;
}
#cities-container {
    display:flex !important; align-items:center; justify-content:center; gap:6px !important; width:100%; margin:0 !important; padding:0 !important;
...
#cities-container button {
    flex:1 1 150px !important; width:auto !important; min-width:135px !important; max-width:280px !important; min-height:44px !important;
    padding:0 15px !important; border:0 !important; outline:0 !important; border-radius:10px !important;
    background:#33323f !important; color:#c8c7d1 !important; text-align:center !important; font-size:10px !important; font-weight:900 !important;
    box-shadow:none !important; scroll-snap-align:start; transform:none !important;
}
...
#cities-container button.bg-indigo-600:hover {
    background:var(--dz-green) !important; color:#fff !important; border:0 !important; outline:0 !important; box-shadow:none !important;
}

.app-city-controls {
    position:relative; overflow:visible !important; padding:15px 16px 15px 20px !important; border-radius:15px !important;
    background:var(--dz-panel) !important; box-shadow:0 10px 30px rgba(0,0,0,.18) !important;
}
.app-city-controls::before {
    content:''; position:absolute; left:0; top:15px; width:5px; height:29px; border-radius:0 5px 5px 0; background:var(--dz-lime);
}
...
#city-menu {
    right:0 !important; width:250px !important; margin:0 !important; padding:6px !important; border:none !important; border-radius:13px !important;
    background:#2d2c38 !important; box-shadow:0 20px 60px rgba(0,0,0,.42) !important; overflow:hidden !important;
}
#city-menu button {
    min-height:40px; padding:0 11px !important; border-radius:9px !important; display:flex; align-items:center; gap:7px;
    background:#393846 !important; color:#fff !important;
}
...
.app-status-toolbar {
    padding:10px !important; border-radius:15px !important; background:var(--dz-panel) !important; box-shadow:0 10px 30px rgba(0,0,0,.18) !important;
}
.app-status-grid { display:grid !important; grid-template-columns:repeat(4,minmax(104px,1fr)); gap:7px !important; flex:1 1 650px; }
.status-chip {
    width:100%; height:58px !important; padding:0 12px !important; border:none !important; border-radius:11px !important; box-shadow:none !important;
...
.territory-card {
    position:relative; display:grid !important; grid-template-columns:minmax(110px,.9fr) minmax(0,1.3fr); grid-template-rows:1fr auto;
    column-gap:18px; row-gap:12px; min-height:258px !important; padding:15px !important; border:none !important; border-radius:15px !important;
    overflow:hidden !important; box-shadow:0 12px 30px rgba(0,0,0,.20) !important; transform-origin:center;
...
.territory-card > div:first-child {
    grid-column:1; grid-row:1; align-self:start; min-width:0;
}
.territory-card .territory-kicker, .territory-card .badge.card-free-badge { display:none !important; }
...
.territory-card .badge {
    min-width:42px; min-height:32px; padding:0 9px !important; border:none !important; border-radius:9px !important;
    display:inline-flex !important; align-items:center; justify-content:center; background:rgba(23,23,31,.30) !important;
    color:#fff !important; font-size:14px !important; font-weight:950 !important;
}

.territory-card > div:nth-child(2) {
    grid-column:2; grid-row:1; display:flex !important; flex-direction:column !important; align-items:flex-start !important;
    min-width:0; min-height:120px; margin:0 !important; padding-top:2px; line-height:1.45; text-align:left !important;
}
.territory-card > div:nth-child(2) p { width:100%; color:rgba(255,255,255,.90) !important; font-size:10px !important; text-align:left !important; }
.territory-card > div:nth-child(2) p b { color:#fff !important; }
.territory-card > div:nth-child(2) > div:last-child {
    margin-top:auto !important; padding-top:10px !important; display:grid !important; grid-template-columns:repeat(2,42px) !important;
    gap:8px !important; width:max-content !important; align-self:flex-end !important;
}

.territory-actions {
    grid-column:1 / -1; grid-row:2; width:100% !important; margin:0 !important; padding:0 !important; min-height:56px;
...
.territory-actions > div:first-child {
    display:grid !important; grid-template-columns:repeat(2,42px) !important; gap:8px !important; width:max-content !important;
}

.territory-card .card-icon-action, .territory-card a.card-map-action, .territory-card .copy-map-btn.card-icon-action {
    ...
    margin:0 !important; padding:0 !important; border:none !important; outline:none !important; border-radius:10px !important;
    display:inline-flex !important; align-items:center !important; justify-content:center !important; flex:0 0 42px !important;
    background:#2b2b37 !important; color:#fff !important; box-shadow:none !important; text-decoration:none !important;
}
.territory-card .card-icon-action i, .territory-card a.card-map-action i { margin:0 !important; padding:0 !important; color:#fff !important; font-size:14px !important; line-height:1 !important; }
.territory-card a.mini-btn.card-map-action {
    width:42px !important; min-width:42px !important; max-width:42px !important; height:42px !important; min-height:42px !important; max-height:42px !important;
    padding:0 !important; background:#2b2b37 !important; color:#fff !important; border:none !important; border-radius:10px !important; box-shadow:none !important;
}
.territory-card a.mini-btn.card-map-action:hover, .territory-card .card-icon-action:not(:disabled):hover { background:var(--dz-green-bright) !important; color:#11141a !important; transform:translateY(-1px) !important; }
.territory-card a.mini-btn.card-map-action:hover i, .territory-card .card-icon-action:not(:disabled):hover i { color:#11141a !important; }

.territory-card .card-main-action {
    width:56px !important; min-width:56px !important; height:56px !important; min-height:56px !important; padding:0 !important; border-radius:12px !important;
    display:inline-flex !important; align-items:center !important; justify-content:center !important; flex:0 0 56px !important;
    background:#262631 !important; color:#fff !important; font-size:19px !important;
}
...
#publishers-page > .glass-panel {
    position:relative; padding:15px 16px 15px 20px !important; border-radius:15px !important; background:var(--dz-panel) !important;
    box-shadow:0 10px 30px rgba(0,0,0,.18) !important;
}
#publishers-page > .glass-panel::before {
    content:''; position:absolute; left:0; top:15px; width:5px; height:29px; border-radius:0 5px 5px 0; background:var(--dz-cyan);
}
...
#publishers-search, #publisher-picker-search, #dialog-fields input {
    height:42px !important; border:none !important; outline:none !important; border-radius:10px !important; background:#191922 !important; color:#fff !important; box-shadow:none !important;
}
...
#publishers-list { display:grid !important; grid-template-columns:1fr !important; gap:8px !important; align-items:stretch !important; }
#publishers-list > div, .publisher-row {
    min-height:58px; height:100%; padding:9px 10px 9px 14px !important; border:none !important; border-radius:12px !important;
    background:var(--dz-panel-soft) !important; box-shadow:none !important; transition:background-color .16s ease,transform .16s ease !important;
    display:grid !important; grid-template-columns:minmax(0,1fr) 92px !important; align-items:center !important; gap:12px !important;
}
#publishers-list > div > b, .publisher-row > b { min-width:0; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
#publishers-list > div > div, .publisher-row > div {
    width:92px !important; display:grid !important; grid-template-columns:repeat(2,42px) !important; gap:8px !important; justify-content:end !important;
}
#publishers-list > div button, .publisher-row button {
    width:42px !important; min-width:42px !important; height:42px !important; min-height:42px !important; padding:0 !important; border-radius:10px !important;
}
...
#dialog-modal .border-b, #dialog-modal .border-t, #history-modal .border-b, #publisher-picker-modal .border-b, .territory-actions.border-t { border:none !important; }
...
@media (max-width:639px) {
    ...
    .app-city-controls { padding:12px 12px 12px 17px !important; align-items:stretch !important; }
    .app-city-controls::before { top:12px; height:25px; }
    ...
    .territory-card { grid-template-columns:minmax(92px,.8fr) minmax(0,1.2fr); min-height:238px !important; padding:13px !important; border-radius:13px !important; column-gap:12px; }
    .territory-card h3 { font-size:1.9rem !important; }
    .territory-card > div:nth-child(2) > div:last-child, .territory-actions > div:first-child { grid-template-columns:repeat(2,42px) !important; gap:7px !important; }
    .territory-card .card-icon-action, .territory-card a.card-map-action, .territory-card .copy-map-btn.card-icon-action, .territory-card a.mini-btn.card-map-action {
    ...
    .territory-card .card-main-action { width:54px !important; min-width:54px !important; height:54px !important; min-height:54px !important; }
...
@media (hover:none), (pointer:coarse) {
    ...
    button:not([data-language-toggle]):not(:disabled):active, a#map-link:active, a.mini-btn:active {
        background:var(--dz-green-bright) !important; color:#11141a !important; transform:scale(.985) !important;
    }
}
`;
...
function decorateFixedSections() {
    ...
    [
        ['st-free','status-chip-free'], ['st-busy','status-chip-busy'],
        ['st-overdue','status-chip-overdue'], ['st-waiting','status-chip-waiting']
